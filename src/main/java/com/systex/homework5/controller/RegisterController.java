...
public class RegisterController {
    ...
    class RegisterRestController {
        ...
        Map<String, String> registerConfirm(HttpServletRequest request, HttpSession session) {
    ...
    RegisterController(PersonRepository personRepository) {
    ...
    String addPerson(@ModelAttribute Person person,
    ...
    private String addPersonImp(Person person,
        ...
        boolean registerConfirm = session.getAttribute("registerConfirm") != null
                && (Boolean)session.getAttribute("registerConfirm");
    ...
    Map<String, String> registerConfirmImp(HttpServletRequest request, HttpSession session) {
